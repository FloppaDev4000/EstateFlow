		...
		<div class = "formContainer">
			...
			<fieldset>
				...
				<div class = "inputbox">
					...
					<input type="text" name="eircode" id="eircode" required autofocus placeholder="Y21 234" pattern="[A-Za-z]{1}\d{2}[ ]?[A-Za-z\d]{4}" disabled >
				</div>
				...
				<div class = "inputbox">
					...
					<input type="text" name="viewing_times" id="viewing_times" placeholder= "Weekends 12pm - 5pm" required pattern="[A-Za-z \d\-\:]+" disabled>
				</div>
